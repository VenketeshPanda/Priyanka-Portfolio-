...
const projectsData = [
  ...
  {
    id: 2,
    heading: "Empowering Strategic Decision",
  ...
  {
    id: 3,
    heading: "Visualising Liability: RAMP Redesign: Streamlining the Legal Risk Resolution Flow",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="space-y-16 md:space-y-20">
          {projectsData.map((project, index) => (
            <div
              key={project.id}
              className="relative border-[4px] border-[#674305] rounded-[32px] overflow-visible p-6 md:p-8"
